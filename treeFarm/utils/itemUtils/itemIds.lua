local itemIds = { -- TODO: allow user edits via config?
  ...
  wirelessModem = { name = "ComputerCraft:CC-Peripheral", damage = 1 },  -- do I need this? -- turtle could take it off to check that it's present
  diamondPickaxe = { name = "minecraft:diamondpickaxe", damage = 0 }, -- TODO: check that this is correct
  ...
  disk = { name = "ComputerCraft:disk", damage = 0 }, -- do I need this?
  diskDrive = { name = "ComputerCraft:CC-Peripheral", damage = 0 }, -- do I need this?
  advanceComputer = { name = "ComputerCraft:CC-Computer", damage = 16384 }, -- do I need this?
  computer = { name = "ComputerCraft:CC-Computer", damage = 0 }, -- do I need this?
